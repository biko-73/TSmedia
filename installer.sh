...
# ==============================================
# SCRIPT : DOWNLOAD AND INSTALL TSmedia #
# =====================================================================================================================
# Command: wget https://raw.githubusercontent.com/biko-73/TSmedia/main/installer.sh -O - | /bin/sh #
# =====================================================================================================================
...
MY_DEB="enigma2-plugin-extensions-tsmedia_17.02_all.deb"
...
echo "**  https://www.tunisia-sat.com/forums/threads/4178310/   **"
echo "************************************************************"
echo ''
